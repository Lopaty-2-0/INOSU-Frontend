      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        allClasses.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="classes" data-v-8adfaf42${_scopeId}><div class="content" data-v-8adfaf42${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-8adfaf42${_scopeId}><div class="section-head" data-v-8adfaf42${_scopeId}><h3 data-v-8adfaf42${_scopeId}>Třídy: ${ssrInterpolate(selectedClasses.value.length)} / ${ssrInterpolate(allClasses.value.length)}</h3><p data-v-8adfaf42${_scopeId}>Vyberte třídy, které chcete trvale odstranit ze systému.</p></div><div class="search" data-v-8adfaf42${_scopeId}><input type="text" name="searchInput" placeholder="Hledat třídy"${ssrRenderAttr("value", searchInput.value)} data-v-8adfaf42${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:search-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="buttons" data-v-8adfaf42${_scopeId}><button class="remove" data-v-8adfaf42${_scopeId}> Odstranit `);
              _push2(ssrRenderComponent(Loading, {
                style: loading.value ? null : { display: "none" },
                size: "5px",
                color: "var(--actionBar-actions-remove-color)"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="reset" data-v-8adfaf42${_scopeId}> Zrušit vše </button></div>`);
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                group: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8adfaf42${_scopeId2}>${ssrInterpolate(data.value.group)}</p>`);
                  } else {
                    return [
                ...
                specialization: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8adfaf42${_scopeId2}>${ssrInterpolate(data.value.specialization)}</p>`);
                  } else {
                    return [
                ...
                class: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8adfaf42${_scopeId2}>${ssrInterpolate(data.value.specialization)}${ssrInterpolate(data.value.grade)}${ssrInterpolate(data.value.group)}</p>`);
                  } else {
                    return [
...
const remove = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8adfaf42"]]);
