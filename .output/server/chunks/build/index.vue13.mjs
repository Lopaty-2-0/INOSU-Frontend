      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        users.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="users" data-v-31754558${_scopeId}><div class="content" data-v-31754558${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-31754558${_scopeId}><div class="section-head" data-v-31754558${_scopeId}><h3 data-v-31754558${_scopeId}>Celkem uživatelů: ${ssrInterpolate(searchedUsers.value.length)}</h3><p data-v-31754558${_scopeId}>Zde vidíte uživatele dané role a třídě. Použijte vyhledávání pro rychlé filtrování seznamu.</p></div><div class="search" data-v-31754558${_scopeId}><input type="text" name="searchInput" placeholder="Hledat uživatele"${ssrRenderAttr("value", searchInput.value)} data-v-31754558${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:search-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="users" data-v-31754558${_scopeId}>`);
                  ...
                  createVNode("div", { class: "content" }, [
                    ...
                    createVNode("div", { class: "line" }, [
                      createVNode("div", { class: "section-head" }, [
                        ...
                        createVNode("p", null, "Zde vidíte uživatele dané role a třídě. Použijte vyhledávání pro rychlé filtrování seznamu.")
                      ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/panel/users/student/[class]/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-31754558"]]);
