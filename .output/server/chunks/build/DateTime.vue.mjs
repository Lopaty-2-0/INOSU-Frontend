import { defineComponent, ref, watch, mergeProps, useSSRContext, reactive, computed, toRefs, nextTick, createBlock, renderSlot, unref, openBlock, resolveDynamicComponent, normalizeProps, inject, toRef, normalizeClass, withCtx, createVNode, createElementVNode, createElementBlock, createCommentVNode, toDisplayString, Fragment, renderList, normalizeStyle, withKeys, withDirectives, watchEffect, provide, guardReactiveProps, resolveComponent, createTextVNode, isRef, Transition, resolveDirective, toHandlers, withModifiers } from 'vue';
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrInterpolate, ssrRenderStyle, ssrRenderComponent } from 'vue/server-renderer';
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props = __props;
    const name = ref({ input: props.oldName, updated: false });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "section" }, _attrs))} data-v-2fe7286d>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`<div class="items name" data-v-2fe7286d><div class="section" data-v-2fe7286d><div class="content" data-v-2fe7286d><label for="name" data-v-2fe7286d>Název</label><input type="text" id="name" name="name"${ssrRenderAttr("placeholder", props.oldName ? props.oldName : "Úkol 1")}${ssrRenderAttr("value", name.value.input)} data-v-2fe7286d></div></div></div></div>`);
    };
  }
});

const _sfc_setup$2 = _sfc_main$n.setup;
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/manage/Name.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const EditName = /* @__PURE__ */ _export_sfc$1(_sfc_main$n, [["__scopeId", "data-v-2fe7286d"]]);
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "section" }, _attrs))} data-v-241186ee>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`<div class="items needApprove" data-v-241186ee><div class="section" data-v-241186ee><div class="content" data-v-241186ee><input type="checkbox" id="needApprove" name="needApprove"${ssrRenderAttr("value", props.oldCheck)}${ssrIncludeBooleanAttr(Array.isArray(check.value.input) ? ssrLooseContain(check.value.input, props.oldCheck) : check.value.input) ? " checked" : ""} data-v-241186ee><label for="needApprove" data-v-241186ee>Nutné schválení</label></div></div></div></div>`);
    };
  }
});

const _sfc_setup$1 = _sfc_main$m.setup;
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/manage/NeedApprove.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const EditNeedApprove = /* @__PURE__ */ _export_sfc$1(_sfc_main$m, [["__scopeId", "data-v-241186ee"]]);
...
function createCalendar(props, { slots, emit }) {
  ...
  const move = async (target, opts = {}) => {
    ...
    if (opts.fromPage && !pageIsEqualToPage(opts.fromPage, firstPage.value)) {
      hidePopover({ id: navPopoverId.value });
      if (opts.view) {
        skipWatcher("view", 10);
...
const _sfc_main$k = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function onMouseLeave() {
      ...
      if (state2.autoHide && !state2.isFocused && (!popperRef || popperRef !== (void 0).activeElement) && ["hover", "hover-focus"].includes(state2.visibility)) {
        hide();
      }
    }
    function onFocusIn() {
...
function createDatePicker(props, { emit, slots }) {
  ...
  function updateValue(value, opts = {}) {
    ...
    return new Promise((resolve) => {
      ...
      if (debounce > 0) {
        updateTimeout = (void 0).setTimeout(() => {
...
const DatePicker = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emits = __emit;
    const date = ref({ input: props.oldDate, updated: false });
    watch(() => props.reset, (reset) => {
      if (reset) {
    ...
    watch(() => date.value.input, () => {
      var _a;
      date.value.updated = !!(date.value.input && date.value.input.getTime() !== ((_a = props.oldDate) == null ? void 0 : _a.getTime()));
      emits("update", date.value.updated ? date.value.input : void 0);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_VDatePicker = DatePicker;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "section" }, _attrs))} data-v-8d831b82>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`<div class="items dateTime" data-v-8d831b82><div class="section" data-v-8d831b82><div class="content" data-v-8d831b82><label for="dateTime" data-v-8d831b82>${ssrInterpolate(props.label ? props.label : "Datum a čas")} <span class="update" style="${ssrRenderStyle(date.value.updated ? null : { display: "none" })}" data-v-8d831b82>(aktualizováno)</span></label>`);
      _push(ssrRenderComponent(_component_VDatePicker, {
        expanded: "",
        transparent: "",
        bordeless: "",
        modelValue: date.value.input,
        "onUpdate:modelValue": ($event) => date.value.input = $event,
        mode: "dateTime",
        "hide-time-header": "",
        is24hr: ""
      }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/manage/DateTime.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const EditDateTime = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-8d831b82"]]);

export { EditName as E, EditDateTime as a, EditNeedApprove as b };
//# sourceMappingURL=DateTime.vue.mjs.map
