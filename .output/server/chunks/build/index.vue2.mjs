      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        unref(allRoles) ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="users" data-v-16084a26${_scopeId}><div class="content" data-v-16084a26${_scopeId}><div class="line" data-v-16084a26${_scopeId}><div class="section-head" data-v-16084a26${_scopeId}><h3 data-v-16084a26${_scopeId}>Celkem uživatelů: ${ssrInterpolate(unref(numberOfUsers))}</h3><p data-v-16084a26${_scopeId}>Zde najdete souhrn všech registrovaných uživatelů v systému.</p></div></div><div class="roles-section" data-v-16084a26${_scopeId}><div class="section-head" data-v-16084a26${_scopeId}><h4 data-v-16084a26${_scopeId}>Role uživatelů</h4></div><div class="roles" data-v-16084a26${_scopeId}><!--[-->`);
              ssrRenderList(unref(allRoles), (role) => {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="section-head" data-v-16084a26${_scopeId2}><span data-v-16084a26${_scopeId2}>${ssrInterpolate(role === "admin" ? "Administrátoři" : role === "teacher" ? "Učitelé" : role === "student" ? "Studenti" : role.charAt(0).toUpperCase() + role.slice(1))}</span></div>`);
                    } else {
                      return [
                        createVNode("div", { class: "section-head" }, [
                          createVNode("span", null, toDisplayString(role === "admin" ? "Administrátoři" : role === "teacher" ? "Učitelé" : role === "student" ? "Studenti" : role.charAt(0).toUpperCase() + role.slice(1)), 1)
                        ])
                      ];
                    }
                  }),
                  ...
                  createVNode("div", { class: "content" }, [
                    createVNode("div", { class: "line" }, [
                      createVNode("div", { class: "section-head" }, [
                        ...
                        createVNode("p", null, "Zde najdete souhrn všech registrovaných uživatelů v systému.")
                      ])
                    ]),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-16084a26"]]);
