    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "panel" }, _attrs), {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="settings" data-v-7dd50a54${_scopeId}>`);
            ...
            _push2(`<div class="content" data-v-7dd50a54${_scopeId}>`);
            _push2(ssrRenderComponent(EditProfilePicture, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-7dd50a54${_scopeId2}><h3 data-v-7dd50a54${_scopeId2}> Profilová fotka <span class="update" style="${ssrRenderStyle(newUserData.value.profilePicture ? null : { display: "none" })}" data-v-7dd50a54${_scopeId2}>(aktualizováno)</span></h3><p data-v-7dd50a54${_scopeId2}>Zde můžete změnit svou profilovou fotku. Nahrajte nový obrázek, pokud si přejete aktualizovat stávající profilovou fotografii.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      ...
                      createVNode("p", null, "Zde můžete změnit svou profilovou fotku. Nahrajte nový obrázek, pokud si přejete aktualizovat stávající profilovou fotografii.")
                    ])
                  ];
                }
              }),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7dd50a54"]]);
