      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        allSpecializations.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="specializations" data-v-5784d66a${_scopeId}><div class="content" data-v-5784d66a${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-5784d66a${_scopeId}><div class="section-head" data-v-5784d66a${_scopeId}><h3 data-v-5784d66a${_scopeId}>Zaměření: ${ssrInterpolate(selectedSpecializations.value.length)} / ${ssrInterpolate(allSpecializations.value.length)}</h3><p data-v-5784d66a${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div><div class="search" data-v-5784d66a${_scopeId}><input type="text" name="searchInput" placeholder="Hledat zaměření"${ssrRenderAttr("value", searchInput.value)} data-v-5784d66a${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:search-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="buttons" data-v-5784d66a${_scopeId}><button class="remove" data-v-5784d66a${_scopeId}> Odstranit `);
              _push2(ssrRenderComponent(Loading, {
                style: loading.value ? null : { display: "none" },
                size: "5px",
                color: "var(--actionBar-actions-remove-color)"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="reset" data-v-5784d66a${_scopeId}> Zrušit vše </button></div>`);
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                abbreviation: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-5784d66a${_scopeId2}>${ssrInterpolate(data.value.abbreviation)}</p>`);
                  } else {
                    return [
...
const remove = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5784d66a"]]);
