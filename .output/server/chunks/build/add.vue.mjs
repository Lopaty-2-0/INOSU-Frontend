    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="settings" data-v-bb73f47d${_scopeId}><div class="content" data-v-bb73f47d${_scopeId}><div class="line page-section" data-v-bb73f47d${_scopeId}>`);
            _push2(ssrRenderComponent(EditFullName, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-bb73f47d${_scopeId2}><h3 data-v-bb73f47d${_scopeId2}>Jméno a příjmení *</h3><p data-v-bb73f47d${_scopeId2}>Zadejte jméno a příjmení nového uživatele. Tato pole jsou povinná.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, "Jméno a příjmení *"),
                      createVNode("p", null, "Zadejte jméno a příjmení nového uživatele. Tato pole jsou povinná.")
                    ])
                  ];
                }
              }),
            ...
            _push2(`</div><div class="line page-section" data-v-bb73f47d${_scopeId}>`);
            _push2(ssrRenderComponent(EditEmail, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-bb73f47d${_scopeId2}><h3 data-v-bb73f47d${_scopeId2}>E-mail * <span class="update" style="${ssrRenderStyle(newUserData.value.email ? null : { display: "none" })}" data-v-bb73f47d${_scopeId2}>(aktualizováno)</span></h3><p data-v-bb73f47d${_scopeId2}>Zadejte e-mailovou adresu nového uživatele. Toto pole je povinné a musí být ve správném formátu.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
                      ...
                      createVNode("p", null, "Zadejte e-mailovou adresu nového uživatele. Toto pole je povinné a musí být ve správném formátu.")
                    ])
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(EditPassword, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-bb73f47d${_scopeId2}><h3 data-v-bb73f47d${_scopeId2}>Heslo k účtu * <span class="update" style="${ssrRenderStyle(newUserData.value.password ? null : { display: "none" })}" data-v-bb73f47d${_scopeId2}>(aktualizováno)</span></h3><p data-v-bb73f47d${_scopeId2}>Zadejte silné heslo pro nového uživatele. Heslo musí splňovat bezpečnostní požadavky a je povinné.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
                      ...
                      createVNode("p", null, "Zadejte silné heslo pro nového uživatele. Heslo musí splňovat bezpečnostní požadavky a je povinné.")
                    ])
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(EditRole, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-bb73f47d${_scopeId2}><h3 data-v-bb73f47d${_scopeId2}>Role * <span class="update" style="${ssrRenderStyle(newUserData.value.role ? null : { display: "none" })}" data-v-bb73f47d${_scopeId2}>(aktualizováno)</span></h3><p data-v-bb73f47d${_scopeId2}>Vyberte roli, kterou má mít nový uživatel. Toto pole je povinné.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
                      ...
                      createVNode("p", null, "Vyberte roli, kterou má mít nový uživatel. Toto pole je povinné.")
                    ])
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(EditAbbreviation, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-bb73f47d${_scopeId2}><h3 data-v-bb73f47d${_scopeId2}>Přezdívka <span class="update" style="${ssrRenderStyle(newUserData.value.abbreviation ? null : { display: "none" })}" data-v-bb73f47d${_scopeId2}>(aktualizováno)</span></h3><p data-v-bb73f47d${_scopeId2}>Zadejte přezdívku (zkratku) pro nového uživatele. Toto pole je volitelné, ale musí být jedinečné.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
                      ...
                      createVNode("p", null, "Zadejte přezdívku (zkratku) pro nového uživatele. Toto pole je volitelné, ale musí být jedinečné.")
                    ])
                  ];
                }
              }),
            ...
            _push2(`</div><div class="line page-section" data-v-bb73f47d${_scopeId}><div class="section-head" data-v-bb73f47d${_scopeId}><h3 data-v-bb73f47d${_scopeId}>Třídy <span class="update" style="${ssrRenderStyle(newUserData.value.classes ? null : { display: "none" })}" data-v-bb73f47d${_scopeId}>(aktualizováno)</span></h3><p data-v-bb73f47d${_scopeId}>Vyberte třídy, do kterých bude nový uživatel (student) zařazen. Toto pole je volitelné.</p></div>`);
            if (newUserData.value.role === "student") {
              ...
              _push2(`<p class="error" data-v-bb73f47d${_scopeId}> Třídy můžete vybírat pouze pokud role uživatele je <strong data-v-bb73f47d${_scopeId}>student</strong>. </p>`);
            }
            _push2(`</div>`);
                ...
                createVNode("div", { class: "content" }, [
                  ...
                  createVNode("div", { class: "line page-section" }, [
                    createVNode("div", { class: "section-head" }, [
                      ...
                      createVNode("p", null, "Vyberte třídy, do kterých bude nový uživatel (student) zařazen. Toto pole je volitelné.")
                    ]),
...
const add = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bb73f47d"]]);
