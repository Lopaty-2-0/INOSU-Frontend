      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        task.value && elaborator.value && guarantor.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="task" data-v-e702d510${_scopeId}><div class="content" data-v-e702d510${_scopeId}><div class="line page-section" data-v-e702d510${_scopeId}><div class="section-head" data-v-e702d510${_scopeId}><h3 data-v-e702d510${_scopeId}>${ssrInterpolate(task.value.name)}</h3><p data-v-e702d510${_scopeId}>Úkol ID: ${ssrInterpolate(task.value.id)}</p><p data-v-e702d510${_scopeId}>Garant: ${ssrInterpolate(guarantor.value.name)} ${ssrInterpolate(guarantor.value.surname)}</p><p data-v-e702d510${_scopeId}>Začátek: ${ssrInterpolate(unref(moment)(task.value.startDate).format("DD.MM. YYYY HH:MM"))}</p><p data-v-e702d510${_scopeId}>Konec: ${ssrInterpolate(unref(moment)(task.value.endDate).format("DD.MM. YYYY HH:MM"))}</p><p data-v-e702d510${_scopeId}>Nutné potvrzení: ${ssrInterpolate(task.value.approve ? "Ano" : "Ne")}</p><div class="profile" data-v-e702d510${_scopeId}><p data-v-e702d510${_scopeId}>Vypracovává:</p><div class="data" data-v-e702d510${_scopeId}><img${ssrRenderAttr("src", "http://89.203.248.163/uploads/profilePictures/" + elaborator.value.profilePicture)} alt="User profile photo" loading="lazy" data-v-e702d510${_scopeId}><span data-v-e702d510${_scopeId}>${ssrInterpolate(elaborator.value.name)} ${ssrInterpolate(elaborator.value.surname)}</span></div></div></div></div><div class="line page-section" data-v-e702d510${_scopeId}><div class="section-head" data-v-e702d510${_scopeId}><h3 data-v-e702d510${_scopeId}>Materiály</h3><div class="line file" data-v-e702d510${_scopeId}><a${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${task.value.id}/${task.value.task}`)} class="link" download target="_blank" data-v-e702d510${_scopeId}>${ssrInterpolate(task.value.task)}</a><a class="icon-div"${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${task.value.id}/${task.value.task}`)} download target="_blank" data-v-e702d510${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:download-2-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</a></div></div></div><div class="line page-section" data-v-e702d510${_scopeId}><div class="section-head" data-v-e702d510${_scopeId}><h3 data-v-e702d510${_scopeId}>Vypracování</h3>`);
              if (task.value.elaboration) {
                _push2(`<div class="line file" data-v-e702d510${_scopeId}><a${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${task.value.id}/${elaborator.value.id}/elaboration/${task.value.elaboration}`)} class="link" download target="_blank" data-v-e702d510${_scopeId}>${ssrInterpolate(task.value.elaboration)}</a><a class="icon-div"${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${task.value.id}/${elaborator.value.id}/elaboration/${task.value.elaboration}`)} download target="_blank" data-v-e702d510${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  class: "icon",
                  name: "material-symbols:download-2-rounded"
                }, null, _parent2, _scopeId));
                ...
                _push2(`<p data-v-e702d510${_scopeId}><span class="error" data-v-e702d510${_scopeId}>Uživatel ještě nevypracoval tento úkol.</span></p>`);
              }
              _push2(`</div></div><div class="line page-section review" data-v-e702d510${_scopeId}>`);
              _push2(ssrRenderComponent(EditTaskFile, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="section-head" data-v-e702d510${_scopeId2}><h3 data-v-e702d510${_scopeId2}>Hodnocení <span class="update" style="${ssrRenderStyle(taskReviewFile.value !== void 0 ? null : { display: "none" })}" data-v-e702d510${_scopeId2}>(aktualizováno)</span></h3><p data-v-e702d510${_scopeId2}>Zde můžete nahrát nebo stáhnout soubor s hodnocením úkolu. Povolené formáty: PDF, DOCX, ODT, HTML nebo ZIP.</p></div>`);
                  } else {
                    return [
              ...
              _push2(`<div class="column" data-v-e702d510${_scopeId}><button class="icon-div" data-v-e702d510${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
              ...
              if (lastUploadedReviewFileName.value || task.value.review) {
                _push2(`<a class="icon-div"${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${task.value.id}/${elaborator.value.id}/review/${lastUploadedReviewFileName.value || task.value.review}`)} download target="_blank" data-v-e702d510${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  class: "icon",
                  name: "material-symbols:download-2-rounded"
                }, null, _parent2, _scopeId));
...
const _userId_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e702d510"]]);
