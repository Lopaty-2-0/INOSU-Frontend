      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(Navbar, {
              links: [
                ...
                { name: "Vypracované", path: `/panel/tasks/teacher/${unref(taskId)}/inProgress` }
              ]
        ...
        pendingUsers.value && task.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="tasks" data-v-3d9796f7${_scopeId}><div class="content" data-v-3d9796f7${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-3d9796f7${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-3d9796f7${_scopeId}><div class="line" data-v-3d9796f7${_scopeId}><div class="section-head" data-v-3d9796f7${_scopeId}><div class="section-head" data-v-3d9796f7${_scopeId}><h3 data-v-3d9796f7${_scopeId}>Vypracovaný úkol</h3><p data-v-3d9796f7${_scopeId}>Úkol ID: ${ssrInterpolate(task.value.id)}</p><p data-v-3d9796f7${_scopeId}>Název: ${ssrInterpolate(task.value.name)}</p><p data-v-3d9796f7${_scopeId}>Garant ID: ${ssrInterpolate(task.value.guarantor)}</p><p data-v-3d9796f7${_scopeId}>Začátek: ${ssrInterpolate(unref(moment)(task.value.startDate).format("DD.MM. YYYY HH:MM"))}</p><p data-v-3d9796f7${_scopeId}>Konec: ${ssrInterpolate(unref(moment)(task.value.endDate).format("DD.MM. YYYY HH:MM"))}</p><p data-v-3d9796f7${_scopeId}>Nutné potvrzení: ${ssrInterpolate(task.value.approve ? "Ano" : "Ne")}</p><p data-v-3d9796f7${_scopeId}> Zadání: <a${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${task.value.id}/${task.value.task}`)} class="link" download target="_blank" data-v-3d9796f7${_scopeId}>${ssrInterpolate(task.value.task)}</a></p></div></div><div class="search" data-v-3d9796f7${_scopeId}><input type="text" name="searchInput" placeholder="Hledat uživatele"${ssrRenderAttr("value", searchInput.value)} data-v-3d9796f7${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                abbreviation: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p class="uppercase" data-v-3d9796f7${_scopeId2}>${ssrInterpolate(data.value.abbreviation || "Není")}</p>`);
                  } else {
                    return [
                ...
                actions: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="actions" data-v-3d9796f7${_scopeId2}><button type="button" class="primary" data-v-3d9796f7${_scopeId2}>Otevřít</button></div>`);
                  } else {
                    return [
                      ...
                      createVNode("div", { class: "line" }, [
                        createVNode("div", { class: "line" }, [
                          createVNode("div", { class: "section-head" }, [
                            createVNode("div", { class: "section-head" }, [
                              createVNode("h3", null, "Vypracovaný úkol"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/panel/tasks/teacher/[taskId]/done.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const done = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3d9796f7"]]);

export { done as default };
//# sourceMappingURL=done.vue2.mjs.map
