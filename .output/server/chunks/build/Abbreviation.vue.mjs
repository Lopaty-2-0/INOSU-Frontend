...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "section" }, _attrs))} data-v-891048cb>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`<div class="section url" data-v-891048cb><div class="content" data-v-891048cb><label for="abbreviation" data-v-891048cb>Přezdívka</label><div class="line" data-v-891048cb><input class="${ssrRenderClass({ error: abbreviation.value.error })}" type="text" id="abbreviation" placeholder="JUDE"${ssrRenderAttr("value", abbreviation.value.input)} data-v-891048cb><div class="icon-div" data-v-891048cb>`);
      _push(ssrRenderComponent(_component_Icon, {
        class: "icon",
      ...
      if (abbreviation.value.error) {
        _push(`<p class="input-error" data-v-891048cb>${ssrInterpolate(abbreviation.value.error)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div>`);
...
const EditAbbreviation = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-891048cb"]]);
