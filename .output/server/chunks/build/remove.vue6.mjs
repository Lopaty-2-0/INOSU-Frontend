      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        users.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="users" data-v-131379a5${_scopeId}><div class="content" data-v-131379a5${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-131379a5${_scopeId}><div class="section-head" data-v-131379a5${_scopeId}><h3 data-v-131379a5${_scopeId}> Uživatelé: ${ssrInterpolate(selectedUsers.value.length)} / ${ssrInterpolate(searchedUsers.value.length)}</h3><p data-v-131379a5${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div><div class="search" data-v-131379a5${_scopeId}><input type="text" name="searchInput" placeholder="Hledat uživatele"${ssrRenderAttr("value", searchInput.value)} data-v-131379a5${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:search-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="buttons" data-v-131379a5${_scopeId}><button class="remove" data-v-131379a5${_scopeId}> Odstranit `);
              _push2(ssrRenderComponent(Loading, {
                style: loading.value ? null : { display: "none" },
                size: "5px",
                color: "var(--actionBar-actions-remove-color)"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="reset" data-v-131379a5${_scopeId}> Zrušit vše </button></div><div class="users" data-v-131379a5${_scopeId}>`);
...
const remove = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-131379a5"]]);
