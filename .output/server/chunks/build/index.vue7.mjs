      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        users.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="users" data-v-bf373625${_scopeId}><div class="content" data-v-bf373625${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-bf373625${_scopeId}><div class="section-head" data-v-bf373625${_scopeId}><h3 data-v-bf373625${_scopeId}>Celkem uživatelů: ${ssrInterpolate(searchedUsers.value.length)}</h3><p data-v-bf373625${_scopeId}>Zde vidíte uživatele dané role. Použijte vyhledávání pro rychlé filtrování seznamu.</p></div><div class="search" data-v-bf373625${_scopeId}><input type="text" name="searchInput" placeholder="Hledat uživatele"${ssrRenderAttr("value", searchInput.value)} data-v-bf373625${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:search-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="users" data-v-bf373625${_scopeId}>`);
                  ...
                  createVNode("div", { class: "content" }, [
                    ...
                    createVNode("div", { class: "line" }, [
                      createVNode("div", { class: "section-head" }, [
                        ...
                        createVNode("p", null, "Zde vidíte uživatele dané role. Použijte vyhledávání pro rychlé filtrování seznamu.")
                      ]),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bf373625"]]);
