...
import { defineComponent, ref, mergeProps, withCtx, createVNode, createTextVNode, withDirectives, vShow, createBlock, createCommentVNode, vModelText, openBlock, toDisplayString, useSSRContext } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "panel" }, _attrs), {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="specializations" data-v-b91131d2${_scopeId}><div class="content" data-v-b91131d2${_scopeId}>`);
            ...
            _push2(`<div class="form" data-v-b91131d2${_scopeId}><div class="section" data-v-b91131d2${_scopeId}><div class="section-head" data-v-b91131d2${_scopeId}><h3 data-v-b91131d2${_scopeId}>Název * <span class="update" style="${ssrRenderStyle(specializationData.value.name ? null : { display: "none" })}" data-v-b91131d2${_scopeId}>(aktualizováno)</span></h3><p data-v-b91131d2${_scopeId}>Zadejte název zaměření, které chcete přidat. Název musí být jedinečný.</p></div><div class="content" data-v-b91131d2${_scopeId}><label for="name" data-v-b91131d2${_scopeId}>Název</label><input type="text" id="name" placeholder="Informační technologie"${ssrRenderAttr("value", specializationData.value.name)} data-v-b91131d2${_scopeId}>`);
            if (errors.value.name.length > 0) {
              _push2(`<p class="input-error" data-v-b91131d2${_scopeId}>${ssrInterpolate(errors.value.name)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="section" data-v-b91131d2${_scopeId}><div class="section-head" data-v-b91131d2${_scopeId}><h3 data-v-b91131d2${_scopeId}>Zkratka * <span class="update" style="${ssrRenderStyle(specializationData.value.abbreviation ? null : { display: "none" })}" data-v-b91131d2${_scopeId}>(aktualizováno)</span></h3><p data-v-b91131d2${_scopeId}>Zadejte jednopísmennou zkratku zaměření. Zkratka musí být unikátní.</p></div><div class="content" data-v-b91131d2${_scopeId}><label for="abbreviation" data-v-b91131d2${_scopeId}>Zkratka</label><input type="text" id="abbreviation" placeholder="V"${ssrRenderAttr("value", specializationData.value.abbreviation)} data-v-b91131d2${_scopeId}>`);
            if (errors.value.abbreviation.length > 0) {
              _push2(`<p class="input-error" data-v-b91131d2${_scopeId}>${ssrInterpolate(errors.value.abbreviation)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="section" data-v-b91131d2${_scopeId}><div class="section-head" data-v-b91131d2${_scopeId}><h3 data-v-b91131d2${_scopeId}>Délka studia * <span class="update" style="${ssrRenderStyle(specializationData.value.lengthOfStudy ? null : { display: "none" })}" data-v-b91131d2${_scopeId}>(aktualizováno)</span></h3><p data-v-b91131d2${_scopeId}>Zadejte délku studia v letech. Minimální hodnota je 1 rok.</p></div><div class="content" data-v-b91131d2${_scopeId}><label for="lengthOfStudy" data-v-b91131d2${_scopeId}>Délka studia</label><input type="number" id="lengthOfStudy" placeholder="1" min="1"${ssrRenderAttr("value", specializationData.value.lengthOfStudy)} data-v-b91131d2${_scopeId}>`);
            if (errors.value.lengthOfStudy.length > 0) {
              _push2(`<p class="input-error" data-v-b91131d2${_scopeId}>${ssrInterpolate(errors.value.lengthOfStudy)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="buttons" data-v-b91131d2${_scopeId}><button type="submit" data-v-b91131d2${_scopeId}> Uložit změny `);
            _push2(ssrRenderComponent(Loading, {
              style: loading.value ? null : { display: "none" },
              size: "5px",
              color: "var(--actionBar-actions-remove-color)"
            }, null, _parent2, _scopeId));
            _push2(`</button><button type="reset" data-v-b91131d2${_scopeId}> Resetovat změny </button></div></div></div>`);
                      ...
                      createVNode("div", { class: "section-head" }, [
                        createVNode("h3", null, [
                          ...
                          withDirectives(createVNode("span", { class: "update" }, "(aktualizováno)", 512), [
                            [vShow, specializationData.value.name]
                          ])
                        ]),
                        createVNode("p", null, "Zadejte název zaměření, které chcete přidat. Název musí být jedinečný.")
                      ]),
                      createVNode("div", { class: "content" }, [
                    ...
                    createVNode("div", { class: "section" }, [
                      createVNode("div", { class: "section-head" }, [
                        createVNode("h3", null, [
                          ...
                          withDirectives(createVNode("span", { class: "update" }, "(aktualizováno)", 512), [
                            [vShow, specializationData.value.abbreviation]
                          ])
                        ]),
                        createVNode("p", null, "Zadejte jednopísmennou zkratku zaměření. Zkratka musí být unikátní.")
                      ]),
                      createVNode("div", { class: "content" }, [
                    ...
                    createVNode("div", { class: "section" }, [
                      createVNode("div", { class: "section-head" }, [
                        createVNode("h3", null, [
                          ...
                          withDirectives(createVNode("span", { class: "update" }, "(aktualizováno)", 512), [
                            [vShow, specializationData.value.lengthOfStudy]
                          ])
                        ]),
                        createVNode("p", null, "Zadejte délku studia v letech. Minimální hodnota je 1 rok.")
                      ]),
                      createVNode("div", { class: "content" }, [
...
const add = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b91131d2"]]);
