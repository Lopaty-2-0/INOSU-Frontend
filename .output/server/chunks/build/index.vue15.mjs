      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        users.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="users" data-v-c8aaa949${_scopeId}><div class="content" data-v-c8aaa949${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-c8aaa949${_scopeId}><div class="section-head" data-v-c8aaa949${_scopeId}><h3 data-v-c8aaa949${_scopeId}>Upravení uživatelů</h3><p data-v-c8aaa949${_scopeId}>Zde si můžete vybrat uživatele, kterého chcete upravit.</p></div><div class="search" data-v-c8aaa949${_scopeId}><input type="text" name="searchInput" placeholder="Hledat uživatele"${ssrRenderAttr("value", searchInput.value)} data-v-c8aaa949${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:search-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="users" data-v-c8aaa949${_scopeId}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c8aaa949"]]);
