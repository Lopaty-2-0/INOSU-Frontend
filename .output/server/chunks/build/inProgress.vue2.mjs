      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        pendingUsers.value && task.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="tasks" data-v-cc2052ea${_scopeId}><div class="content" data-v-cc2052ea${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-cc2052ea${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-cc2052ea${_scopeId}><div class="line" data-v-cc2052ea${_scopeId}><div class="section-head" data-v-cc2052ea${_scopeId}><div class="section-head" data-v-cc2052ea${_scopeId}><h3 data-v-cc2052ea${_scopeId}>Rozpracovaný úkol</h3><p data-v-cc2052ea${_scopeId}>Úkol ID: ${ssrInterpolate(task.value.id)}</p><p data-v-cc2052ea${_scopeId}>Název: ${ssrInterpolate(task.value.name)}</p><p data-v-cc2052ea${_scopeId}>Garant ID: ${ssrInterpolate(task.value.guarantor)}</p><p data-v-cc2052ea${_scopeId}>Začátek: ${ssrInterpolate(unref(moment)(task.value.startDate).format("DD.MM. YYYY HH:MM"))}</p><p data-v-cc2052ea${_scopeId}>Konec: ${ssrInterpolate(unref(moment)(task.value.endDate).format("DD.MM. YYYY HH:MM"))}</p><p data-v-cc2052ea${_scopeId}>Nutné potvrzení: ${ssrInterpolate(task.value.approve ? "Ano" : "Ne")}</p><p data-v-cc2052ea${_scopeId}> Zadání: <a${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${task.value.id}/${task.value.task}`)} class="link" download target="_blank" data-v-cc2052ea${_scopeId}>${ssrInterpolate(task.value.task)}</a></p></div></div><div class="search" data-v-cc2052ea${_scopeId}><input type="text" name="searchInput" placeholder="Hledat uživatele"${ssrRenderAttr("value", searchInput.value)} data-v-cc2052ea${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                name: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="profile" data-v-cc2052ea${_scopeId2}><img${ssrRenderAttr("src", "http://89.203.248.163/uploads/profilePictures/" + data.value.profilePicture)} alt="User profile photo" loading="lazy" data-v-cc2052ea${_scopeId2}><p data-v-cc2052ea${_scopeId2}>${ssrInterpolate(data.value.name)} ${ssrInterpolate(data.value.surname)}</p></div>`);
                  } else {
                    return [
                ...
                abbreviation: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p class="uppercase" data-v-cc2052ea${_scopeId2}>${ssrInterpolate(data.value.abbreviation || "Není")}</p>`);
                  } else {
                    return [
                ...
                actions: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="actions" data-v-cc2052ea${_scopeId2}><button type="button" class="primary" data-v-cc2052ea${_scopeId2}>Otevřít</button></div>`);
                  } else {
                    return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/panel/tasks/teacher/[taskId]/inProgress.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const inProgress = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cc2052ea"]]);

export { inProgress as default };
//# sourceMappingURL=inProgress.vue2.mjs.map
