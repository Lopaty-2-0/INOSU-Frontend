      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        users.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="users" data-v-29f8893a${_scopeId}><div class="content" data-v-29f8893a${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-29f8893a${_scopeId}><div class="section-head" data-v-29f8893a${_scopeId}><h3 data-v-29f8893a${_scopeId}>Upravení uživatelů</h3><p data-v-29f8893a${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div><div class="search" data-v-29f8893a${_scopeId}><input type="text" name="searchInput" placeholder="Hledat uživatele"${ssrRenderAttr("value", searchInput.value)} data-v-29f8893a${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:search-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="users" data-v-29f8893a${_scopeId}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-29f8893a"]]);
