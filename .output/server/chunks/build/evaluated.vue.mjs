      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        allTasks.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="tasks" data-v-69106a0e${_scopeId}><div class="content" data-v-69106a0e${_scopeId}><div class="line" data-v-69106a0e${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-69106a0e${_scopeId}><div class="line" data-v-69106a0e${_scopeId}><div class="section-head" data-v-69106a0e${_scopeId}><h3 data-v-69106a0e${_scopeId}>Vyhodnocené úkoly</h3><p data-v-69106a0e${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div><div class="search" data-v-69106a0e${_scopeId}><input type="text" name="searchInput" placeholder="Hledat úkol"${ssrRenderAttr("value", searchInput.value)} data-v-69106a0e${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                task: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<a${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${data.value.id}/${data.value.task}`)} class="link" download target="_blank" data-v-69106a0e${_scopeId2}>${ssrInterpolate(data.value.task)}</a>`);
                  } else {
                    return [
                      createVNode("a", {
                ...
                startDate: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-69106a0e${_scopeId2}>${ssrInterpolate(unref(moment)(data.value.startDate).format("DD.MM. YYYY HH:MM"))}</p>`);
                  } else {
                    return [
                ...
                endDate: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-69106a0e${_scopeId2}>${ssrInterpolate(unref(moment)(data.value.endDate).format("DD.MM. YYYY HH:MM"))}</p>`);
                  } else {
                    return [
                ...
                approve: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-69106a0e${_scopeId2}>${ssrInterpolate(data.value.approve ? "Ano" : "Ne")}</p>`);
                  } else {
                    return [
                ...
                actions: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="actions" data-v-69106a0e${_scopeId2}><button type="button" class="primary" data-v-69106a0e${_scopeId2}>Otevřít</button></div>`);
                  } else {
                    return [
...
const evaluated = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-69106a0e"]]);
