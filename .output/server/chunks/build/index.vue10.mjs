      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        allSpecializations.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="specializations" data-v-1b79c0c1${_scopeId}><div class="content" data-v-1b79c0c1${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-1b79c0c1${_scopeId}><div class="section-head" data-v-1b79c0c1${_scopeId}><h3 data-v-1b79c0c1${_scopeId}>Všechny zaměření</h3><p data-v-1b79c0c1${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div><div class="search" data-v-1b79c0c1${_scopeId}><input type="text" name="searchInput" placeholder="Hledat zaměření"${ssrRenderAttr("value", searchInput.value)} data-v-1b79c0c1${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                abbreviation: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-1b79c0c1${_scopeId2}>${ssrInterpolate(data.value.abbreviation)}</p>`);
                  } else {
                    return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1b79c0c1"]]);
