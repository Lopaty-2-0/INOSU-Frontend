    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "panel" }, _attrs), {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="access-denied" data-v-0e29c1fa${_scopeId}><div class="content" data-v-0e29c1fa${_scopeId}><div class="icon-div" data-v-0e29c1fa${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "material-symbols:visibility-lock-rounded",
              class: "icon"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="text" data-v-0e29c1fa${_scopeId}><h1 data-v-0e29c1fa${_scopeId}>Přístup odepřen</h1><p data-v-0e29c1fa${_scopeId}>Nemáte dostatečná oprávnění pro zobrazení této stránky.</p></div><div class="group-btn" data-v-0e29c1fa${_scopeId}>`);
...
const _403 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0e29c1fa"]]);
