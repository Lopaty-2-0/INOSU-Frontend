    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "panel" }, _attrs), {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="settings" data-v-836cccbf${_scopeId}>`);
            ...
            _push2(`<div class="content" data-v-836cccbf${_scopeId}>`);
            _push2(ssrRenderComponent(EditThemeMode, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-836cccbf${_scopeId2}><h3 data-v-836cccbf${_scopeId2}> Tématický režim <span class="update" style="${ssrRenderStyle(newUserData.value.themeMode !== void 0 && oldUserData.value.themeMode !== newUserData.value.themeMode ? null : { display: "none" })}" data-v-836cccbf${_scopeId2}>(aktualizováno)</span></h3><p data-v-836cccbf${_scopeId2}>Zvolte preferovaný vzhled rozhraní. Vyberte si mezi světlým, tmavým nebo systémovým režimem podle svých potřeb.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      ...
                      createVNode("p", null, "Zvolte preferovaný vzhled rozhraní. Vyberte si mezi světlým, tmavým nebo systémovým režimem podle svých potřeb.")
                    ])
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(EditCustomLinks, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-836cccbf${_scopeId2}><h3 data-v-836cccbf${_scopeId2}> Vlastní odkazy <span class="update" style="${ssrRenderStyle(newUserData.value.customLinks && JSON.stringify(oldUserData.value.customLinks) !== JSON.stringify(newUserData.value.customLinks) ? null : { display: "none" })}" data-v-836cccbf${_scopeId2}>(aktualizováno)</span></h3><p data-v-836cccbf${_scopeId2}>Zde můžete spravovat své vlastní odkazy, které se zobrazí v uživatelském rozhraní. Přidejte, upravte nebo odeberte odkazy podle svých preferencí.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
                      ...
                      createVNode("p", null, "Zde můžete spravovat své vlastní odkazy, které se zobrazí v uživatelském rozhraní. Přidejte, upravte nebo odeberte odkazy podle svých preferencí.")
                    ])
                  ];
                }
              }),
...
const customization = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-836cccbf"]]);
