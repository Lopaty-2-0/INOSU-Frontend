    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "panel" }, _attrs), {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="settings" data-v-625afb4f${_scopeId}>`);
            ...
            _push2(`<div class="content" data-v-625afb4f${_scopeId}>`);
            _push2(ssrRenderComponent(EditPassword, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-625afb4f${_scopeId2}><h3 data-v-625afb4f${_scopeId2}>Resetování hesla `);
                  if (userData.value.passwords.new !== userData.value.passwords.old && passwordRulesCheck.value[0] && userData.value.passwords.old !== "") {
                    _push3(`<span class="update" data-v-625afb4f${_scopeId2}>(aktualizováno)</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</h3><p data-v-625afb4f${_scopeId2}>Zadejte nové heslo podle doporučených pravidel níže.</p><div class="password-rules" data-v-625afb4f${_scopeId2}><h4 data-v-625afb4f${_scopeId2}>Doporučená pravidla hesla</h4><ul data-v-625afb4f${_scopeId2}><li data-v-625afb4f${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_Icon, {
                    class: "icon",
                    size: "16px",
                    name: "material-symbols:play-arrow-rounded"
                  }, null, _parent3, _scopeId2));
                  _push3(` <p data-v-625afb4f${_scopeId2}>Obsahuje minimálně 5 znaků `);
                  if (passwordRulesCheck.value[0]) {
                    _push3(ssrRenderComponent(_component_Icon, {
                      size: "16px",
                  ...
                  _push3(`</p></li><li data-v-625afb4f${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_Icon, {
                    class: "icon",
                    size: "16px",
                    name: "material-symbols:play-arrow-rounded"
                  }, null, _parent3, _scopeId2));
                  _push3(` <p data-v-625afb4f${_scopeId2}>Obsahuje 2 až 3 znaky: velké, malé, čísla `);
                  ...
                  _push3(` <p data-v-625afb4f${_scopeId2}>Obsahuje aspoň 1 speciální znak: @, #, $, %, &amp;, *, +, = `);
                  ...
                  _push3(` <p data-v-625afb4f${_scopeId2}>Neobsahuje žádné mezery `);
                  ...
                  _push3(` <p data-v-625afb4f${_scopeId2}>Neobsahuje žádné osobní informace</p></li></ul></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      ...
                      createVNode("p", null, "Zadejte nové heslo podle doporučených pravidel níže."),
...
const security = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-625afb4f"]]);
