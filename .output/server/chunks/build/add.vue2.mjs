      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        allSpecializations.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="classes" data-v-e773e4f0${_scopeId}><div class="content" data-v-e773e4f0${_scopeId}>`);
              ...
              _push2(`<div class="form" data-v-e773e4f0${_scopeId}><div class="section" data-v-e773e4f0${_scopeId}><div class="section-head" data-v-e773e4f0${_scopeId}><h3 data-v-e773e4f0${_scopeId}>Název * <span class="update" style="${ssrRenderStyle(classData.value.name ? null : { display: "none" })}" data-v-e773e4f0${_scopeId}>(aktualizováno)</span></h3><p data-v-e773e4f0${_scopeId}>Zadejte název nové třídy. Název by měl být unikátní a jasně identifikovat třídu v systému.</p></div><div class="content" data-v-e773e4f0${_scopeId}><label for="name" data-v-e773e4f0${_scopeId}>Název</label><input type="text" id="name" placeholder="V1B-ANJ1"${ssrRenderAttr("value", classData.value.name)} data-v-e773e4f0${_scopeId}>`);
              if (errors.value.name.length > 0) {
                _push2(`<p class="input-error" data-v-e773e4f0${_scopeId}>${ssrInterpolate(errors.value.name)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><div class="section" data-v-e773e4f0${_scopeId}><div class="section-head" data-v-e773e4f0${_scopeId}><h3 data-v-e773e4f0${_scopeId}>Zaměření * <span class="update" style="${ssrRenderStyle(classData.value.specialization ? null : { display: "none" })}" data-v-e773e4f0${_scopeId}>(aktualizováno)</span></h3><p data-v-e773e4f0${_scopeId}>Vyberte zaměření, ke kterému bude nová třída přiřazena. Můžete filtrovat podle názvu, zkratky nebo délky studia.</p></div><div class="content" data-v-e773e4f0${_scopeId}><div class="search" data-v-e773e4f0${_scopeId}><label for="searchName" data-v-e773e4f0${_scopeId}> Název <input id="searchName" placeholder="Vyhledat název"${ssrRenderAttr("value", searchName.value)} data-v-e773e4f0${_scopeId}></label><label for="searchAbbreviation" data-v-e773e4f0${_scopeId}> Zkratka <input id="searchAbbreviation" placeholder="V"${ssrRenderAttr("value", searchAbbreviation.value)} data-v-e773e4f0${_scopeId}></label><label for="searchLengthOfStudy" data-v-e773e4f0${_scopeId}> Délka studia <input id="searchLengthOfStudy" min="1" max="10" placeholder="3" type="number"${ssrRenderAttr("value", searchLengthOfStudy.value)} data-v-e773e4f0${_scopeId}></label></div><label data-v-e773e4f0${_scopeId}>Výběr zaměření</label><div class="dropdown" data-v-e773e4f0${_scopeId}><div class="title" data-v-e773e4f0${_scopeId}><p data-v-e773e4f0${_scopeId}>${ssrInterpolate(title.value || "Vyberte zaměření")}</p>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: open.value ? icons.close : icons.open
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="dropdown-content" style="${ssrRenderStyle(open.value ? null : { display: "none" })}" data-v-e773e4f0${_scopeId}>`);
              if (unref(searchedSpecializations).length > 0) {
                _push2(`<!--[-->`);
                ssrRenderList(unref(searchedSpecializations), (item) => {
                  _push2(`<div class="${ssrRenderClass([{ selected: selectedSpecialization.value === item.id }, "item"])}" data-v-e773e4f0${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_Icon, {
                    class: "icon",
                    name: selectedSpecialization.value === item.id ? icons.select : icons.selected
                  }, null, _parent2, _scopeId));
                  _push2(`<span data-v-e773e4f0${_scopeId}>`);
                  if (item.name) {
                    _push2(`<span class="name" data-v-e773e4f0${_scopeId}>${ssrInterpolate(item.name + " - ")}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`<span class="uppercase" data-v-e773e4f0${_scopeId}>${ssrInterpolate(item.abbreviation + " - ")}</span><span data-v-e773e4f0${_scopeId}>Délka studia (roky): ${ssrInterpolate(item.lengthOfStudy)}</span></span></div>`);
                });
                _push2(`<!--]-->`);
              } else {
                _push2(`<div class="item error" data-v-e773e4f0${_scopeId}><p data-v-e773e4f0${_scopeId}>Žádné zaměření nebylo nalezeno.</p></div>`);
              }
              _push2(`</div></div>`);
              if (errors.value.specialization.length > 0) {
                _push2(`<p class="input-error" data-v-e773e4f0${_scopeId}>${ssrInterpolate(errors.value.specialization)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><div class="section" data-v-e773e4f0${_scopeId}><div class="section-head" data-v-e773e4f0${_scopeId}><h3 data-v-e773e4f0${_scopeId}>Ročník * <span class="update" style="${ssrRenderStyle(classData.value.grade ? null : { display: "none" })}" data-v-e773e4f0${_scopeId}>(aktualizováno)</span></h3><p data-v-e773e4f0${_scopeId}>Zadejte ročník, do kterého nová třída patří. Ročník musí být celé číslo větší než 0 a nesmí přesahovat délku studia zvoleného zaměření.</p></div><div class="content" data-v-e773e4f0${_scopeId}><label for="grade" data-v-e773e4f0${_scopeId}>Ročník</label><input type="number" id="grade" placeholder="1" min="1"${ssrRenderAttr("value", classData.value.grade)} data-v-e773e4f0${_scopeId}>`);
              if (errors.value.grade.length > 0) {
                _push2(`<p class="input-error" data-v-e773e4f0${_scopeId}>${ssrInterpolate(errors.value.grade)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><div class="section" data-v-e773e4f0${_scopeId}><div class="section-head" data-v-e773e4f0${_scopeId}><h3 data-v-e773e4f0${_scopeId}>Skupina * <span class="update" style="${ssrRenderStyle(classData.value.group ? null : { display: "none" })}" data-v-e773e4f0${_scopeId}>(aktualizováno)</span></h3><p data-v-e773e4f0${_scopeId}>Zadejte označení skupiny, například písmeno A. Skupina musí být tvořena právě jedním znakem.</p></div><div class="content" data-v-e773e4f0${_scopeId}><label for="group" data-v-e773e4f0${_scopeId}>Skupina</label><input type="text" id="group" placeholder="A"${ssrRenderAttr("value", classData.value.group)} data-v-e773e4f0${_scopeId}>`);
              if (errors.value.group.length > 0) {
                _push2(`<p class="input-error" data-v-e773e4f0${_scopeId}>${ssrInterpolate(errors.value.group)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div></div><div class="buttons" data-v-e773e4f0${_scopeId}><button type="submit" data-v-e773e4f0${_scopeId}> Uložit změny `);
              _push2(ssrRenderComponent(Loading, {
                style: loading.value ? null : { display: "none" },
                size: "5px",
                color: "var(--actionBar-actions-remove-color)"
              }, null, _parent2, _scopeId));
              _push2(`</button><button type="reset" data-v-e773e4f0${_scopeId}> Resetovat změny </button></div></div></div>`);
                    ...
                    createVNode("div", { class: "form" }, [
                      createVNode("div", { class: "section" }, [
                        createVNode("div", { class: "section-head" }, [
                          ...
                          createVNode("p", null, "Zadejte název nové třídy. Název by měl být unikátní a jasně identifikovat třídu v systému.")
                        ]),
                        createVNode("div", { class: "content" }, [
                      ...
                      createVNode("div", { class: "section" }, [
                        createVNode("div", { class: "section-head" }, [
                          ...
                          createVNode("p", null, "Vyberte zaměření, ke kterému bude nová třída přiřazena. Můžete filtrovat podle názvu, zkratky nebo délky studia.")
                        ]),
                        createVNode("div", { class: "content" }, [
                      ...
                      createVNode("div", { class: "section" }, [
                        createVNode("div", { class: "section-head" }, [
                          ...
                          createVNode("p", null, "Zadejte ročník, do kterého nová třída patří. Ročník musí být celé číslo větší než 0 a nesmí přesahovat délku studia zvoleného zaměření.")
                        ]),
                        createVNode("div", { class: "content" }, [
                      ...
                      createVNode("div", { class: "section" }, [
                        createVNode("div", { class: "section-head" }, [
                          ...
                          createVNode("p", null, "Zadejte označení skupiny, například písmeno A. Skupina musí být tvořena právě jedním znakem.")
                        ]),
                        createVNode("div", { class: "content" }, [
...
const add = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e773e4f0"]]);
