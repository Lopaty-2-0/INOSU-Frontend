    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "panel" }, _attrs), {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="tasks" data-v-bfafd367${_scopeId}><div class="content" data-v-bfafd367${_scopeId}>`);
            ...
            _push2(`<div class="line page-section" data-v-bfafd367${_scopeId}>`);
            _push2(ssrRenderComponent(EditName, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-bfafd367${_scopeId2}><h3 data-v-bfafd367${_scopeId2}>Název * <span class="update" style="${ssrRenderStyle(newData.value.name ? null : { display: "none" })}" data-v-bfafd367${_scopeId2}>(aktualizováno)</span></h3><p data-v-bfafd367${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam consequatur mollitia officiis placeat!</p></div>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="line page-section" data-v-bfafd367${_scopeId}>`);
            _push2(ssrRenderComponent(EditTaskFile, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-bfafd367${_scopeId2}><h3 data-v-bfafd367${_scopeId2}>Zadání * <span class="update" style="${ssrRenderStyle(newData.value.taskFile ? null : { display: "none" })}" data-v-bfafd367${_scopeId2}>(aktualizováno)</span></h3><p data-v-bfafd367${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam consequatur mollitia officiis placeat!</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
            ...
            _push2(`</div><div class="line page-section" data-v-bfafd367${_scopeId}><div class="section-head" data-v-bfafd367${_scopeId}><h3 data-v-bfafd367${_scopeId}>Časové rozmezí úkolu *</h3><p data-v-bfafd367${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam consequatur mollitia officiis placeat!</p></div><div class="line" data-v-bfafd367${_scopeId}>`);
            ...
            _push2(`</div></div><div class="line page-section" data-v-bfafd367${_scopeId}>`);
            _push2(ssrRenderComponent(EditNeedApprove, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-bfafd367${_scopeId2}><h3 data-v-bfafd367${_scopeId2}>Nutné schválení * <span class="update" style="${ssrRenderStyle(newData.value.needApprove !== void 0 ? null : { display: "none" })}" data-v-bfafd367${_scopeId2}>(aktualizováno)</span></h3><p data-v-bfafd367${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam consequatur mollitia officiis placeat!</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
...
const add = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bfafd367"]]);
