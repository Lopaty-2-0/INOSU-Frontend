      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(Navbar, {
              links: [
                ...
                { name: "Odstranění", path: "/panel/users/" + unref(role) + "/remove" }
              ]
        ...
        users.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="users" data-v-8d53afbf${_scopeId}><div class="content" data-v-8d53afbf${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-8d53afbf${_scopeId}><div class="section-head" data-v-8d53afbf${_scopeId}><h3 data-v-8d53afbf${_scopeId}> Uživatelé: ${ssrInterpolate(selectedUsers.value.length)} / ${ssrInterpolate(searchedUsers.value.length)}</h3><p data-v-8d53afbf${_scopeId}>Vyberte uživatele, které chcete odstranit, nebo použijte vyhledávání pro zúžení výběru.</p></div><div class="search" data-v-8d53afbf${_scopeId}><input type="text" name="searchInput" placeholder="Hledat uživatele"${ssrRenderAttr("value", searchInput.value)} data-v-8d53afbf${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                class: "icon",
                name: "material-symbols:search-rounded"
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="buttons" data-v-8d53afbf${_scopeId}><button class="remove" data-v-8d53afbf${_scopeId}> Odstranit `);
              _push2(ssrRenderComponent(Loading, {
                style: loading.value ? null : { display: "none" },
                size: "5px",
                color: "var(--actionBar-actions-remove-color)"
              }, null, _parent2, _scopeId));
              _push2(`</button><button class="reset" data-v-8d53afbf${_scopeId}> Zrušit vše </button></div><div class="users" data-v-8d53afbf${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/panel/users/[role]/remove.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const remove = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8d53afbf"]]);

export { remove as default };
//# sourceMappingURL=remove.vue3.mjs.map
