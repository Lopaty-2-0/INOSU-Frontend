      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        allClasses.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="classes" data-v-ae6cb67e${_scopeId}><div class="content" data-v-ae6cb67e${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-ae6cb67e${_scopeId}><div class="section-head" data-v-ae6cb67e${_scopeId}><h3 data-v-ae6cb67e${_scopeId}>Všechny třídy</h3><p data-v-ae6cb67e${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div><div class="search" data-v-ae6cb67e${_scopeId}><input type="text" name="searchInput" placeholder="Hledat třídy"${ssrRenderAttr("value", searchInput.value)} data-v-ae6cb67e${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                group: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-ae6cb67e${_scopeId2}>${ssrInterpolate(data.value.group)}</p>`);
                  } else {
                    return [
                ...
                specialization: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-ae6cb67e${_scopeId2}>${ssrInterpolate(data.value.specialization)}</p>`);
                  } else {
                    return [
                ...
                class: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-ae6cb67e${_scopeId2}>${ssrInterpolate(data.value.specialization)}${ssrInterpolate(data.value.grade)}${ssrInterpolate(data.value.group)}</p>`);
                  } else {
                    return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ae6cb67e"]]);
