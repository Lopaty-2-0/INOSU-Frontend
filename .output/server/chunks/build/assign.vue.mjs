      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        allClasses.value && task.value && allStudents.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="tasks" data-v-53a8f2ac${_scopeId}><div class="content" data-v-53a8f2ac${_scopeId}><div class="line page-section" data-v-53a8f2ac${_scopeId}><div class="section-head" data-v-53a8f2ac${_scopeId}><h3 data-v-53a8f2ac${_scopeId}>${ssrInterpolate(task.value.name)}</h3><p data-v-53a8f2ac${_scopeId}>Úkol ID: ${ssrInterpolate(task.value.id)}</p><p data-v-53a8f2ac${_scopeId}>Garant ID: ${ssrInterpolate(task.value.guarantor)}</p><p data-v-53a8f2ac${_scopeId}>Začátek: ${ssrInterpolate(unref(moment)(task.value.startDate).format("DD.MM. YYYY HH:MM"))}</p><p data-v-53a8f2ac${_scopeId}>Konec: ${ssrInterpolate(unref(moment)(task.value.endDate).format("DD.MM. YYYY HH:MM"))}</p><p data-v-53a8f2ac${_scopeId}>Nutné potvrzení: ${ssrInterpolate(task.value.approve ? "Ano" : "Ne")}</p><p data-v-53a8f2ac${_scopeId}> Zadání: <a${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${task.value.id}/${task.value.task}`)} class="link" download target="_blank" data-v-53a8f2ac${_scopeId}>${ssrInterpolate(task.value.task)}</a></p></div></div>`);
              if (oldSelectedClasses.value.length <= 0 && oldSelectedUsers.value.length <= 0) {
                _push2(`<div class="line page-section" data-v-53a8f2ac${_scopeId}><div class="section-head" data-v-53a8f2ac${_scopeId}><h3 data-v-53a8f2ac${_scopeId}>Přiřazení pro (třídy/žáky)</h3><p data-v-53a8f2ac${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div><div class="${ssrRenderClass([{ open: open.value }, "dropdown"])}" data-v-53a8f2ac${_scopeId}><div class="title" data-v-53a8f2ac${_scopeId}><span data-v-53a8f2ac${_scopeId}>${ssrInterpolate(title.value)}</span><div class="icon-div" data-v-53a8f2ac${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  class: "icon",
                  name: open.value ? icons.close : icons.open
                }, null, _parent2, _scopeId));
                _push2(`</div></div><div class="dropdown-content" style="${ssrRenderStyle(open.value ? null : { display: "none" })}" data-v-53a8f2ac${_scopeId}><!--[-->`);
                ssrRenderList(dropdownItems.value, (item, index) => {
                  _push2(`<div class="${ssrRenderClass([{ selected: selectedDropdown.value === index }, "section"])}" data-v-53a8f2ac${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_Icon, {
                    class: "icon",
                    name: selectedDropdown.value === index ? icons.select : icons.selected
                  }, null, _parent2, _scopeId));
                  _push2(`<span data-v-53a8f2ac${_scopeId}>${ssrInterpolate(item)}</span></div>`);
                });
                _push2(`<!--]--></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="line page-section" style="${ssrRenderStyle(editClass.value ? null : { display: "none" })}" data-v-53a8f2ac${_scopeId}><div class="section-head" data-v-53a8f2ac${_scopeId}><h3 data-v-53a8f2ac${_scopeId}> Třídy <span class="update" style="${ssrRenderStyle(JSON.stringify([...selectedClasses.value || []].sort()) !== JSON.stringify([...oldSelectedClasses.value || []].sort()) ? null : { display: "none" })}" data-v-53a8f2ac${_scopeId}>(aktualizováno)</span></h3><p data-v-53a8f2ac${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div>`);
              ...
              _push2(`</div><div class="line page-section" style="${ssrRenderStyle(!editClass.value ? null : { display: "none" })}" data-v-53a8f2ac${_scopeId}><div class="section-head" data-v-53a8f2ac${_scopeId}><h3 data-v-53a8f2ac${_scopeId}> Žáci <span class="update" style="${ssrRenderStyle(JSON.stringify([...selectedUsers.value || []].sort()) !== JSON.stringify([...oldSelectedUsers.value || []].sort()) ? null : { display: "none" })}" data-v-53a8f2ac${_scopeId}>(aktualizováno)</span></h3><p data-v-53a8f2ac${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div>`);
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                name: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="profile" data-v-53a8f2ac${_scopeId2}><img${ssrRenderAttr("src", "http://89.203.248.163/uploads/profilePictures/" + data.value.profilePicture)} alt="User profile photo" loading="lazy" data-v-53a8f2ac${_scopeId2}><p data-v-53a8f2ac${_scopeId2}>${ssrInterpolate(data.value.name)} ${ssrInterpolate(data.value.surname)}</p></div>`);
                  } else {
                    return [
                ...
                abbreviation: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p class="uppercase" data-v-53a8f2ac${_scopeId2}>${ssrInterpolate(data.value.abbreviation || "Není")}</p>`);
                  } else {
                    return [
                ...
                createdAt: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-53a8f2ac${_scopeId2}>${ssrInterpolate(unref(moment)(data.value.createdAt).format("DD.MM. YYYY HH:MM"))}</p>`);
                  } else {
                    return [
...
const assign = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-53a8f2ac"]]);
