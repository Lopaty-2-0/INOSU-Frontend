      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(Navbar, {
              links: [
                ...
                { name: "Vypracované", path: `/panel/tasks/admin/${unref(taskId)}/inProgress` }
              ]
        ...
        pendingUsers.value && task.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="tasks" data-v-17e5f5c3${_scopeId}><div class="content" data-v-17e5f5c3${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-17e5f5c3${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                name: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="profile" data-v-17e5f5c3${_scopeId2}><img${ssrRenderAttr("src", "http://89.203.248.163/uploads/profilePictures/" + data.value.profilePicture)} alt="User profile photo" loading="lazy" data-v-17e5f5c3${_scopeId2}><p data-v-17e5f5c3${_scopeId2}>${ssrInterpolate(data.value.name)} ${ssrInterpolate(data.value.surname)}</p></div>`);
                  } else {
                    return [
                ...
                abbreviation: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p class="uppercase" data-v-17e5f5c3${_scopeId2}>${ssrInterpolate(data.value.abbreviation || "Není")}</p>`);
                  } else {
                    return [
                ...
                actions: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="actions" data-v-17e5f5c3${_scopeId2}><button type="button" class="primary" data-v-17e5f5c3${_scopeId2}>Otevřít</button></div>`);
                  } else {
                    return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/panel/tasks/admin/[taskId]/done.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const done = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-17e5f5c3"]]);

export { done as default };
//# sourceMappingURL=done.vue.mjs.map
