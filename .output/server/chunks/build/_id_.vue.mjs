    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="settings" data-v-1431fc93${_scopeId}><div class="content" data-v-1431fc93${_scopeId}><div class="line page-section" data-v-1431fc93${_scopeId}>`);
            _push2(ssrRenderComponent(EditProfilePicture, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-1431fc93${_scopeId2}><h3 data-v-1431fc93${_scopeId2}> Profilová fotka <span class="update" style="${ssrRenderStyle(newUserData.value.profilePicture ? null : { display: "none" })}" data-v-1431fc93${_scopeId2}>(aktualizováno)</span></h3><p data-v-1431fc93${_scopeId2}>Změňte svůj profilový obrázek</p></div>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="line page-section" data-v-1431fc93${_scopeId}>`);
            _push2(ssrRenderComponent(EditFullName, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-1431fc93${_scopeId2}><h3 data-v-1431fc93${_scopeId2}>Jméno a příjmení</h3><p data-v-1431fc93${_scopeId2}>Změňte své jméno a příjmení</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
            ...
            _push2(ssrRenderComponent(EditEmail, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-1431fc93${_scopeId2}><h3 data-v-1431fc93${_scopeId2}>E-mail <span class="update" style="${ssrRenderStyle(newUserData.value.email ? null : { display: "none" })}" data-v-1431fc93${_scopeId2}>(aktualizováno)</span></h3><p data-v-1431fc93${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
            ...
            _push2(ssrRenderComponent(EditPassword, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-1431fc93${_scopeId2}><h3 data-v-1431fc93${_scopeId2}>Heslo k účtu <span class="update" style="${ssrRenderStyle(newUserData.value.password ? null : { display: "none" })}" data-v-1431fc93${_scopeId2}>(aktualizováno)</span></h3><p data-v-1431fc93${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
            ...
            _push2(ssrRenderComponent(EditRole, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-1431fc93${_scopeId2}><h3 data-v-1431fc93${_scopeId2}>Role <span class="update" style="${ssrRenderStyle(newUserData.value.role ? null : { display: "none" })}" data-v-1431fc93${_scopeId2}>(aktualizováno)</span></h3><p data-v-1431fc93${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
            ...
            _push2(ssrRenderComponent(EditAbbreviation, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="section-head" data-v-1431fc93${_scopeId2}><h3 data-v-1431fc93${_scopeId2}>Přezdívka <span class="update" style="${ssrRenderStyle(newUserData.value.abbreviation ? null : { display: "none" })}" data-v-1431fc93${_scopeId2}>(aktualizováno)</span></h3><p data-v-1431fc93${_scopeId2}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "section-head" }, [
                      createVNode("h3", null, [
            ...
            _push2(`</div><div class="line page-section" data-v-1431fc93${_scopeId}><div class="section-head" data-v-1431fc93${_scopeId}><h3 data-v-1431fc93${_scopeId}>Třída <span class="update" style="${ssrRenderStyle(newUserData.value.classes ? null : { display: "none" })}" data-v-1431fc93${_scopeId}>(aktualizováno)</span></h3><p data-v-1431fc93${_scopeId}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p></div>`);
            if (newUserData.value.role ? newUserData.value.role === "student" : oldUserData.value.role === "student") {
              ...
              _push2(`<p class="error" data-v-1431fc93${_scopeId}> Třídy můžete vybírat pouze pokud role uživatele je <strong data-v-1431fc93${_scopeId}>student</strong>. </p>`);
            }
            _push2(`</div>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1431fc93"]]);
