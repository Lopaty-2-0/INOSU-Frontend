      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        ...
        allTasks.value ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div id="tasks" data-v-dd0a2437${_scopeId}><div class="content" data-v-dd0a2437${_scopeId}>`);
              ...
              _push2(`<div class="line" data-v-dd0a2437${_scopeId}><div class="line" data-v-dd0a2437${_scopeId}><div class="line" data-v-dd0a2437${_scopeId}><div class="section-head" data-v-dd0a2437${_scopeId}><h3 data-v-dd0a2437${_scopeId}>Vytvořené úkoly</h3><p data-v-dd0a2437${_scopeId}>Seznam vašich vytvořených úkolů, s kterými můžete pracovat.</p></div><div class="search" data-v-dd0a2437${_scopeId}><input type="text" name="searchInput" placeholder="Hledat úkol"${ssrRenderAttr("value", searchInput.value)} data-v-dd0a2437${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(unref(Vue3Datatable), {
                ...
                task: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<a${ssrRenderAttr("href", `http://89.203.248.163/uploads/tasks/${data.value.id}/${data.value.task}`)} class="link" download target="_blank" data-v-dd0a2437${_scopeId2}>${ssrInterpolate(data.value.task)}</a>`);
                  } else {
                    return [
                      createVNode("a", {
                ...
                startDate: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-dd0a2437${_scopeId2}>${ssrInterpolate(unref(moment)(data.value.startDate).format("DD.MM. YYYY HH:MM"))}</p>`);
                  } else {
                    return [
                ...
                endDate: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-dd0a2437${_scopeId2}>${ssrInterpolate(unref(moment)(data.value.endDate).format("DD.MM. YYYY HH:MM"))}</p>`);
                  } else {
                    return [
                ...
                approve: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-dd0a2437${_scopeId2}>${ssrInterpolate(data.value.approve ? "Ano" : "Ne")}</p>`);
                  } else {
                    return [
                ...
                actions: withCtx((data, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="actions" data-v-dd0a2437${_scopeId2}><button type="button" class="default" data-v-dd0a2437${_scopeId2}>Otevřít</button><button type="button" class="assign" data-v-dd0a2437${_scopeId2}>Přiřadit</button></div>`);
                  } else {
                    return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/panel/tasks/admin/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd0a2437"]]);
