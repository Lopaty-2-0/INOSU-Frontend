...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[{"tagPosition":"head","innerHTML":"(function () {\n            try {\n              const storedTheme = localStorage.getItem(\"theme\");\n              const prefersDark = window.matchMedia(\"(prefers-color-scheme: dark)\").matches;\n              let themeAttr;\n\n              if (storedTheme === \"dark\" || storedTheme === \"light\") {\n                themeAttr = storedTheme;\n              } else if (storedTheme === \"system\" || !storedTheme) {\n                themeAttr = prefersDark ? \"dark\" : \"light\";\n              } else {\n                themeAttr = \"light\";\n              }\n\n              document.documentElement.setAttribute(\"data-theme\", themeAttr);\n            } catch (e) {}\n          })();","type":"text/javascript"}],"noscript":[{"innerHTML":"JavaScript is required"}],"htmlAttrs":{"data-theme":"light","lang":"cs"},"charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
