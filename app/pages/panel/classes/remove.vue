    ...
    <template #content v-if="allClasses">
      <div id="classes">
        <div class="content">
          ...
          <ClassesTable :selected-ids="selectedClasses" :loading="classesTablePending" ref="datatable" :classes="allClasses" :search="searchInput" :has-checkbox="true" @row-clicked="onRowClicked" />
