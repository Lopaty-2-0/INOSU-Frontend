    ...
    <div class="container">
      ...
      <form @submit.prevent="submitLoginForm" @input="resetErrors">
        <div class="item">
          ...
          <p v-if="errors.login.length > 0" class="error">{{ errors.login }}</p>
        </div>

        <div class="item">
          <label for="password">Heslo</label>
          <input id="password" v-model="loginData.password" type="password" name="password" placeholder="*****">
          <p v-if="errors.password.length > 0" class="error">{{ errors.password }}</p>
        </div>
        ...
        <div class="footer">
          ...
          <p v-if="errors.req.length > 0" class="error">{{ errors.req }}</p>
        </div>
